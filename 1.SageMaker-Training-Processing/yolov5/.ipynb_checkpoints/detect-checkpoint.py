...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
        ...
        data=ROOT / 'data/data_sm.yaml',  # dataset.yaml path
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'code/data/data_sm.yaml', help='(optional) dataset.yaml path')  ## for SageMaker + Code
